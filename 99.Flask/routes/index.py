...
def constructor(settings):
    ...
    def before_request_func():
        ...
        settings.navigation.secondary.filename = 'navigation'
        settings.navigation.secondary.title = 'Flask'
    ...
    def get_index():
        ...
        # Render the template.
        return render_template(get_render_template_path(slug=request.path, theme=settings.theme), settings=settings, form=form, data=data)
