...
def constructor(settings):
    ...
    @router.route('/economic/', methods=['GET'])
    def get_economic():
    ...
    @router.route('/economic/', methods=['POST'])
    def post_economic():
        # Dynamically import modules by filename.
        model = import_model(filename, suffix='__economic')
    ...
    @router.route('/sports/', methods=['GET'])
    def get_sports():
        # Set the parameters to pass when rendering the template.
        form = {}
        data = {}
    ...
    @router.route('/sports/', methods=['POST'])
    def post_sports():
        # Dynamically import modules by filename.
        model = import_model(filename, suffix='__sports')
