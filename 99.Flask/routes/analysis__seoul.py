...
def constructor(settings):
    ...
    @router.route('/cctv/', methods=['POST'])
    def post_cctv():
        # Dynamically import modules by filename.
        model = import_model(filename, suffix='__cctv')
    ...
    @router.route('/crime/', methods=['GET'])
    def get_crime():
        # Set the parameters to pass when rendering the template.
        form = {}
        data = {}
    ...
    @router.route('/crime/', methods=['POST'])
    def post_crime():
        # Dynamically import modules by filename.
        model = import_model(filename, suffix='__crime')
    ...
    @router.route('/park/', methods=['POST'])
    def post_park():
        # Dynamically import modules by filename.
        model = import_model(filename, suffix='__park')
